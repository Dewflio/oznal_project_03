...
First we create and select the discrete features of the data set, so that we can perform correlation analysis.

```{r pressure, echo=FALSE, fig.cap="When we mutated key and created Bayessian network.", out.width = '70%'}
...
následne treba zodpovedať minimálne 5 marketingovo predajných otázok.
