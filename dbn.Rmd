...
```{r pressure, echo=FALSE, fig.cap="An example of utilizing a non-correlated feature such as 'key' in a Bayesian network.", out.width = '50%'}
...
```{r}
ratio_of <- function(value, feature) {
    sum(feature == value) / length(feature)
}
```

| $D$   |                             | $P(D)$                                      |                                                                                                                                                                                                                                                                                                                                                                                                            |
|-------|-----------------------------|---------------------------------------------|
| $D^+$ | Song is highly danceable.   | `r ratio_of(1, discrete_data$danceability)` |
| $D^-$ | Song is not very danceable. | `r ratio_of(1, discrete_data$danceability)` |

| $E$   |                             | $P(E)$                                |                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|-------|-----------------------------|---------------------------------------|
| $E^+$ | Song is very energetic.     | `r ratio_of(1, discrete_data$energy)` |
| $E^-$ | Song is not very energetic. | `r ratio_of(0, discrete_data$energy)` |

| $L$   |                 | $P(L)$                                  |                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|-------|-----------------|-----------------------------------------|
| $L^+$ | Song is louder. | `r ratio_of(1, discrete_data$loudness)` |
| $L^-$ | Song is soft.   | `r ratio_of(0, discrete_data$loudness)` |

| $V$   |                | $P(V)$                                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|-------|----------------|----------------------------------------|
| $V^+$ | Song is happy. | `r ratio_of(1, discrete_data$valence)` |
| $V^-$ | Song is sad.   | `r ratio_of(0, discrete_data$valence)` |

| $M$   |                        | $P(M)$                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|-------|------------------------|-------------------------------------|
| $M^+$ | Song is in major mode. | `r ratio_of(1, discrete_data$mode)` | 
| $M^-$ | Song is in minor mode. | `r ratio_of(0, discrete_data$mode)` |

| $TS$   |                          | $P(TS)$                                       |                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|--------|--------------------------|-----------------------------------------------|
| $TS^+$ | Song has 4 beats.        | `r ratio_of(1, discrete_data$time_signature)` | 
| $TS^-$ | Song has 1,3 or 5 beats. | `r ratio_of(0, discrete_data$time_signature)` |

| $T$   |               | $P(T)$                               |                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|-------|---------------|--------------------------------------|
| $T^+$ | Song is fast. | `r ratio_of(1, discrete_data$tempo)` |
| $T^-$ | Song is slow. | `r ratio_of(0, discrete_data$tempo)` |
