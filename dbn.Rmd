...
b) $P(L=l^+|E=e^+) = \frac{P(L=l^+)}{P(E=e^+)} = \frac{0.561953}{0.5361585} = 0,3012959$

c) $P(V=v^+|E=e^+) = \frac{P(V=v^+)}{P(E=e^+)} = \frac{0.4942423}{0.5361585} = 0,2649922$
